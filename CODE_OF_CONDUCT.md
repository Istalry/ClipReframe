...
maintainers through GitHub's private vulnerability reporting form on this repository
(**Security → Report a vulnerability**, which reaches the maintainers privately) or by opening an
issue if the matter is not sensitive. All complaints will be reviewed and investigated promptly
and fairly.
